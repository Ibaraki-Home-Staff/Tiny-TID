(function(){
  ...
  var legacyMap = {
    index: '/assets/js/legacy-index.js?v=4',
    tid: '/assets/js/legacy-tid.js?v=4'
  };
  var modernMap = {
    index: ['/assets/js/pwa.js?v=3', '/assets/js/main.js?v=42'],
    tid: ['/assets/js/pwa.js?v=3', '/assets/js/tid.js?v=41']
  };
